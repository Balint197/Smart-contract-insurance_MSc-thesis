...
contract YourContract {
    ...
    event NewContract(uint id, string name);
    ...
    function nextStage(uint _id) internal {
        insuranceContracts[_id].contractState = ContractStates(uint8(insuranceContracts[_id].contractState) + 1);
